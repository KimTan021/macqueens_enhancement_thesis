...
def process_cluster(df, cluster_label):
    ...
    Returns:
    folium.Map: A folium map with crime markers for the specified cluster.
    pd.DataFrame: The processed DataFrame with sub-cluster labels.
    """
    ...
    optimal_k, labels, outliers = find_optimal_clusters(cluster_df[["CRIME CODE"]], plot=False)
